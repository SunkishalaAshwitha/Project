...
<head>
    ...
    <title>ONLINE ADVERTISEMENT MANAGEMENT SYSTEM</title>
...
<body>
    <div class="container">
        <div class="navbar">
            <div class="title">
                <div class="name">ONLINE ADVERTISEMENT MANAGEMENT SYSTEM</div>
            </div>
            <div class="buttons">
                <a href="/login" class="bn3637">Login</a>
                <a  class="bn59"  href="/register"> Register</a>
                 <a  class="bn3637"  href="/AboutUs"> About Us</a>
                 <a  class="bn3637"  href="/ContactUs"> Contact</a>
                 <a  class="bn3637"  href="/Billing"> Billing</a>
            
                 
    <div class="dropdown">
        <div class="dropbtn">Team</div>
        <div class="dropdown-content">
            <a href="/creative">Ideology Team</a>
